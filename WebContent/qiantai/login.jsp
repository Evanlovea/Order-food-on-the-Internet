...
<table  width="900px" border="1"  align="center" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <div id='spdv_391' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
        <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:#fff;">
          ...
          <div style="padding:0px">
            ...
            <div style="width:600px; height:210px;text-align:left;border:1px #f59d5e solid; border-radius:5px;background-color:#fdebd5;padding:30px;margin:0px">
              <div style="width:210px;float:left;text-align:left;border:1px #f59d5e solid;padding:20px;border-radius:10px ;background-color:#ffffff;">
              ...
              <div style="width:290px;padding:20px;float:right;text-align:left;border:1px #f59d5e solid;border-radius:5px;background-color:#ffffff;">
